...
public class Categoria extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      switch(categoria){
          case "tutti": ArrayList<ProductBean> tutti= (ArrayList<ProductBean>) model.doRetriveAll(null);
          ...
          case "carrozzeria": ArrayList<ProductBean> carrozzeria= (ArrayList<ProductBean>) model.doRetriveCarrozzeria(null);
          ...
          case "pneumatici": ArrayList<ProductBean> pneumatici= (ArrayList<ProductBean>) model.doRetrivePneumatici(null);
          ...
          case "meccanica": ArrayList<ProductBean> meccanica= (ArrayList<ProductBean>) model.doRetriveMeccanica(null);
